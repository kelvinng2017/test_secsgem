...
class SecsS01F03(SecsStreamFunction):
    ...
    **Example**::
    ...
    _dataFormat = SVID # Mike: 2020/03/09
...
class SecsS01F04(SecsStreamFunction):
    ...
    **Example**::
    ...
    _dataFormat = [SV] # Mike: 2020/03/09
...
class SecsS02F31(SecsStreamFunction): # Mike 2019/09/05
    """equipment constant namelist
    ...
    **Example**::
        ...
        >>> import secsgem
        >>> secsgem.SecsS02F31(["TIME": 20190903171300])
        S2F31
          <A "20190903171300"> .
...
class SecsS02F32(SecsStreamFunction): # Mike 2019/09/05
    """equipment constant namelist

    **Data Items**

    - :class:`TIACK <secsgem.secs.dataitems.TIACK>`
    ...
    **Example**::
        ...
        >>> import secsgem
        >>> secsgem.SecsS02F32(secsgem.TIACK.ACK)
        S2F32
          <B 0x0> .
...
class SecsS02F49(SecsStreamFunction): # Mike: 2020/03/09
    """host command - send
    ...
    **Data Items**
    ...
    - :class:`RCMD <secsgem.secs.dataitems.RCMD>`
    - :class:`CPNAME <secsgem.secs.dataitems.CPNAME>`
    - :class:`CEPVAL <secsgem.secs.dataitems.CEPVAL>`
    ...
    **Example**::
        ...
        >>> import secsgem
        >>> secsgem.SecsS02F49({"RCMD": "COMMAND", "PARAMS": [{"CPNAME": "PARAM1", "CEPVALS": [{"CPNAME":"PARAM11", "CPVAL":"VAL11"}, {"CPNAME":"PARAM12", "CPVAL":"VAL12"}]}, {"CPNAME": "PARAM2", "CEPVALS": [{"CPNAME":"PARAM21", "CPVAL":"VAL21"}, {"CPNAME":"PARAM22", "CPVAL":"VAL22"}]}]})
        S2F49 W
          <L [2]
            <A "COMMAND">
            <L [2]
...
class SecsS02F50(SecsStreamFunction): # Mike: 2020/03/09
    """host command - acknowledge
    ...
    **Example**::
        ...
        >>> secsgem.SecsS02F50({ \
            "HCACK": secsgem.HCACK.INVALID_COMMAND, \
            "PARAMS": [ \
                {"CPNAME": "PARAM1", "CEPACK": secsgem.CEPACK.CEPVAL_ILLEGAL_VALUE}, \
                {"CPNAME": "PARAM2", "CEPACK": secsgem.CEPACK.CEPVAL_ILLEGAL_FORMAT}]})
        S2F42
          <L [2]
            <B 0x1>
            <L [2]
...
class SecsS06F23(SecsStreamFunction): # Mike 2019/09/05
    """annotated individual report data
    ...
    **Example**::
        ...
        >>> import secsgem
        >>> secsgem.SecsS06F23(secsgem.RSDC.TRANSMIT)
        S6F23
          <U1 0> .
...
class SecsS06F24(SecsStreamFunction): # Mike 2019/09/05
    """annotated individual report data
    ...
    **Example**::
        ...
        >>> import secsgem
        >>> secsgem.SecsS06F24(secsgem.RSDA.OK)
        S6F22
          <B[1] 0> .
...
secsStreamsFunctions = {
    ...
    2: {
        ...
        29: SecsS02F29,
        30: SecsS02F30,
        31: SecsS02F31, # Mike 2019/09/05
        32: SecsS02F32, # Mike 2019/09/05
        33: SecsS02F33,
        34: SecsS02F34,
        35: SecsS02F35,
        36: SecsS02F36,
        ...
        41: SecsS02F41,
        42: SecsS02F42,
        49: SecsS02F49, # Mike 2020/03/09
        50: SecsS02F50, # Mike 2020/03/09
    },
    5: {
        0: SecsS05F00,
        1: SecsS05F01,
    ...
    6: {
        ...
        21: SecsS06F21,
        22: SecsS06F22,
        23: SecsS06F23, # Mike 2019/09/05
        24: SecsS06F24, # Mike 2019/09/05
    },
    7: {
        1: SecsS07F01,
        2: SecsS07F02,
