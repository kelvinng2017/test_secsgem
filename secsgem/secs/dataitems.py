...
from .variables import SecsVarArray, SecsVarString, SecsVarBinary, \
    ...
    SecsVarU2, SecsVarU4, SecsVarU8, SecsVarBoolean, SecsVarDynamic, SecsVarList
...
class ALID(DataItemBase):
    ...
    **Used In Function**
    ...
    __allowedtypes__ = [SecsVarArray, SecsVarU1, SecsVarU2, SecsVarU4, SecsVarU8, SecsVarI1, SecsVarI2, SecsVarI4, SecsVarI8]
...
class CEPACK(DataItemBase): # Mike: 2020/03/19
    ...
    **Values**
        ...
        | Value | Description            | Constant                                                     |
        +=======+========================+==============================================================+
        | 0     | Acknowledge            | :const:`secsgem.secs.dataitems.CEPACK.ACK`                   |
        +-------+------------------------+--------------------------------------------------------------+
        | 1     | Parameter name unknown | :const:`secsgem.secs.dataitems.CEPACK.PARAMETER_UNKNOWN`     |
        +-------+------------------------+--------------------------------------------------------------+
        | 2     | CEPVAL value illegal   | :const:`secsgem.secs.dataitems.CEPACK.CEPVAL_ILLEGAL_VALUE`  |
        +-------+------------------------+--------------------------------------------------------------+
        | 3     | CEPVAL format illegal  | :const:`secsgem.secs.dataitems.CEPACK.CEPVAL_ILLEGAL_FORMAT` |
        +-------+------------------------+--------------------------------------------------------------+
        | 4     | CPNAME not valid       | :const:`secsgem.secs.dataitems.CEPACK.CPNAME_NOT_VALID`      |
        +-------+------------------------+--------------------------------------------------------------+
        | 4-63  | Reserved               |                                                              |
        +-------+------------------------+--------------------------------------------------------------+
...
class CEPVAL(DataItemBase): # Mike: 2021/07/07
    """Command parameter name

    :Types:
       - :class:`SecsVarBinary <secsgem.secs.variables.SecsVarArray>`
       - :class:`SecsVarBinary <secsgem.secs.variables.SecsVarList>`
       - :class:`SecsVarBinary <secsgem.secs.variables.SecsVarBinary>`
       - :class:`SecsVarBoolean <secsgem.secs.variables.SecsVarBoolean>`
       - :class:`SecsVarString <secsgem.secs.variables.SecsVarString>`
       - :class:`SecsVarI8 <secsgem.secs.variables.SecsVarI8>`
    ...
    **Used In Function**
    ...
    __type__ = SecsVarDynamic
    __allowedtypes__ = [SecsVarBoolean, SecsVarU1, SecsVarU2, SecsVarU4, SecsVarU8, SecsVarI1, SecsVarI2, SecsVarI4, SecsVarI8, SecsVarString, SecsVarBinary, SecsVarArray, SecsVarList]
...
class CPVAL(DataItemBase):
    ...
    **Used In Function**
    ...
    __type__ = SecsVarDynamic
    __allowedtypes__ = [SecsVarBoolean, SecsVarU1, SecsVarU2, SecsVarU4, SecsVarU8, SecsVarI1, SecsVarI2, SecsVarI4, SecsVarI8, SecsVarString, SecsVarBinary, SecsVarList]
...
class EC_PORT_ID(DataItemBase):
    ...
    **Used In Function**
        - :class:`SecsS02F14 <secsgem.secs.functions.SecsS02F20>`
    """
...
class EP_CARRIER_ID(DataItemBase):
    """Equipment constant value
...
class EP_DOCKING_TIME(DataItemBase):
    """Equipment constant value
...
class EP_PRODUCT_ID(DataItemBase):
    """Equipment constant value
...
class EP_WAFER_CNT(DataItemBase):
    """Equipment constant value
...
class RSDA(DataItemBase): # Mike 2019/09/05
    """Request Spooled Data Acknowledgement
    ...
    **Values**
        ...
        | Value | Description    | Constant                                     |
        +=======+================+==============================================+
        | 0     | Ok             | :const:`secsgem.secs.dataitems.RSDA.OK`      |
        +-------+----------------+----------------------------------------------+
        | 1     | Retryable busy | :const:`secsgem.secs.dataitems.RSDA.RETRY`   |
        +-------+----------------+----------------------------------------------+
        | 2     | No spool data  | :const:`secsgem.secs.dataitems.RSDA.NO_DATA` |
        +-------+----------------+----------------------------------------------+

    **Used In Function**
        - :class:`SecsS6F24 <secsgem.secs.functions.SecsS06F24>`
...
class RSDC(DataItemBase): # Mike 2019/09/05
    ...
    **Used In Function**
        - :class:`SecsS6F23 <secsgem.secs.functions.SecsS06F23>`
...
class SV(DataItemBase):
    ...
    :Types:
       ...
       - :class:`SecsVarBoolean <secsgem.secs.variables.SecsVarBoolean>`
       - :class:`SecsVarString <secsgem.secs.variables.SecsVarString>`
       - :class:`SecsVarString <secsgem.secs.variables.SecsVarList>`
       - :class:`SecsVarI8 <secsgem.secs.variables.SecsVarI8>`
       - :class:`SecsVarI1 <secsgem.secs.variables.SecsVarI1>`
       - :class:`SecsVarI2 <secsgem.secs.variables.SecsVarI2>`
       - :class:`SecsVarI4 <secsgem.secs.variables.SecsVarI4>`
    ...
    **Used In Function**
    ...
    __type__ = SecsVarDynamic    
    __allowedtypes__ = [SecsVarArray, SecsVarBoolean, SecsVarU1, SecsVarU2, SecsVarU4, SecsVarU8, SecsVarI1, SecsVarI2, SecsVarI4, SecsVarI8, \
        SecsVarF4, SecsVarF8, SecsVarString, SecsVarBinary, SecsVarList]
...
class SVID(DataItemBase):
    ...
    **Used In Function**
    ...
    __type__ = SecsVarDynamic    
    __allowedtypes__ = [SecsVarArray, SecsVarU1, SecsVarU2, SecsVarU4, SecsVarU8, SecsVarI1, SecsVarI2, SecsVarI4, SecsVarI8, SecsVarString]
...
class TIACK(DataItemBase): # Mike 2019/09/06
    ...
    **Values**
        ...
        | Value | Description   | Constant                                    |
        +=======+===============+=============================================+
        | 0     | OK            | :const:`secsgem.secs.dataitems.TIACK.OK`    |
        +-------+---------------+---------------------------------------------+
        | 1     | Error         | :const:`secsgem.secs.dataitems.TIACK.ERROR` |
        +-------+---------------+---------------------------------------------+

    **Used In Function**
        - :class:`SecsS12F02 <secsgem.secs.functions.SecsS02F32>`
