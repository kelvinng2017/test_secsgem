...
class SecsVarDynamic(SecsVar):
    ...
    def set(self, value):
        ...
        **Example**::
        ...
        if isinstance(value, SecsVar):
            ...
            if isinstance(matched_type, tuple): # Mike: 2021/07/19
                self.value = matched_type[0](matched_type[1])
            else:
    ...
    def _match_type(self, value):
        ...
        if isinstance(value, list): # Mike: 2021/07/19
            return (SecsVarArray, ANYVALUE)
        ...
        for var_type in var_types:
            if not hasattr(var_type, 'supports_value'):
