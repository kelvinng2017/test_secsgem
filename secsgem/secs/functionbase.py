    ...
    **Example**::
    ...
    def __repr__(self):
        ...
        if self.data is None:
            return "{}{} .".format(function, (" W" if self._isReplyRequired else " [W]") if self._hasReply else "") # Mike: 2019/12/18
        data = "{}".format(self.data.__repr__())

        return "{}{}\n{} .".format(
            function,
            (" W" if self._isReplyRequired else " [W]") if self._hasReply else "", # Mike: 2019/12/18
            indent_block(data))
