...
if __name__ == '__main__':
    global_variables.RackNaming=12
    global_variables.Format_RackPort_Parse=r'(ER\d+)P(\d+)'
    global_variables.Format_RackPort_Print='%sP%d'
    global_variables.Format_Rack_Parse=r'(ER\d+)'
    ...
    h=MFErackAdapter(secsgem_e88_h, setting, secsgem_e88_h.Transfers, secsgem_e88_h.Carriers, secsgem_e88_h.Zones)
