...
SV_DoorState=649 #peter 240705,test call elevator for K11
SV_ALTX=651
SV_ALSV=652
SV_UnitType=653
SV_UnitID=654
...
EventTable={
    ...
    OpenDoorAcquire: {'report':[SV_VehicleID,SV_TransferPort,SV_DoorState]},#peter 240705,test call elevator for K11
}
